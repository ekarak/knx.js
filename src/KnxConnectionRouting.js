...
var KnxReceiverRouting = require('./KnxReceiverRouting');
var KnxSenderRouting   = require('./KnxSenderRouting');
...
**/
function KnxConnectionRouting(mcastIpAddr, mcastIpPort) {
  if (!mcastIpAddr) mcastIpAddr = '224.0.23.12';
  if (!mcastIpPort) mcastIpPort = 3671;
  KnxConnectionRouting.super_.call(this, mcastIpAddr, mcastIpPort);
}
util.inherits(KnxConnectionRouting, KnxConnection);


/// <summary>
///     Bind the multicast socket
/// </summary>
KnxConnectionRouting.prototype.BindSocket = function () {
...
KnxConnectionRouting.prototype.InitialiseSenderReceiver = function() {
...
KnxConnectionRouting.prototype.GenerateSequenceNumber = function () {
    return this._sequenceNumber++;
}

KnxConnectionRouting.prototype.RevertSingleSequenceNumber = function () {
    this._sequenceNumber--;
}

KnxConnectionRouting.prototype.ResetSequenceNumber = function () {
...
KnxConnectionRouting.prototype.InitializeStateRequest = function () {
    var self = this;
		if (self.debug) console.log("KnxConnectionRouting.prototype.InitializeStateRequest...");
...
KnxConnectionRouting.prototype.TerminateStateRequest = function () {
	if (this.debug) console.log("KnxConnectionRouting.prototype.TerminateStateRequest...");
...
KnxConnectionRouting.prototype.ConnectRequest = function (callback) {
	if (this.debug) console.log("KnxConnectionRouting.prototype.ConnectRequest...");
    // HEADER
...
KnxConnectionRouting.prototype.StateRequest = function (callback) {
    // HEADER
...
KnxConnectionRouting.prototype.DisconnectRequest = function (callback) {
    if(!this.connected) {
			  if (typeof callback === 'function') callback();
        return false;
    }
...
module.exports = KnxConnectionRouting;
